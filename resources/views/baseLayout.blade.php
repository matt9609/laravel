...
<head>
    ...
    <link href="layouts/layout4/css/layout.css" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="{{URL::to('/')}}">
                <img src="global/img/logo-big-black.png" height="74" alt="logo" class="logo-default" /> </a>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <img alt="" class="img-circle" src="http://www.petzoned.com/assets/default_avatar-468e8f42276a2fd234b034f28536570b.png" /> </a>
...
<script src="global/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>
...
<script src="pages/scripts/components-bootstrap-select.js" type="text/javascript"></script>
