...
<div class="logo">
    <a href="index.html">
        <img src="global/img/logo_email.png" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    @endif
    {!! Form::open(array('url' => 'login','class'=>'login-form', 'id' => 'FormularioLogin')) !!}
    ...
    {!! Form::submit('Iniciar Sesión' , array('class' => 'loginbutton btn green uppercase')) !!}
    ...
    {!! Form::close() !!}
    <!-- END LOGIN FORM -->
    {!! Form::open(array('url' => 'register','class'=>'register-form', 'id' => 'FormularioRegistro')) !!}
