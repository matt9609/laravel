(function ($){
	...
	$.fn.stepify = function(options){
		...
		var prevBtnStr = '<a href="/"><div class="btn btn-danger '+opt.prevBtn.cssClass+'">'+opt.prevBtn.text+'</div></a>',
		nextBtnStr = '<div class="btn '+opt.nextBtn.cssClass+'">'+opt.nextBtn.text+'</div>',
		submitBtnStr = '<input type="submit" class="btn btn-info btn-submit" value="'+opt.submitBtn.text+'" ></input>',
		divStr = '<div></div>';
